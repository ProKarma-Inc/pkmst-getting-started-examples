...
public class OrderReceiptListener {
	...
	private String paymentProcessedDest;
	...
	private void sendConfirmation(String sessionId) throws JmsException, JsonProcessingException {
		...
		this.jmsTemplate.convertAndSend(this.paymentProcessedDest, this.objectMapper.writeValueAsString(confirmation));
	}
	...
	private void processPayment(Order order) {
		...
		// I am doing some really busy work .
		try {
			Thread.sleep(7000);
